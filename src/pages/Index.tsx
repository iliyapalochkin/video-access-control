                  ...
                  return (
                    <div className="w-full h-full bg-gradient-to-br from-blue-900 to-purple-900 flex items-center justify-center">
                      <div className="text-center text-white p-8">
                        <Icon name="Play" size={64} className="mx-auto mb-4 text-blue-400" />
                        <h3 className="text-2xl font-bold mb-4">Видео готово к просмотру</h3>
                        <p className="text-lg mb-6 text-gray-300">
                          Нажмите кнопку ниже, чтобы открыть видео в полноэкранном режиме
                        </p>
                        <a
                          href={directLink}
                          target="_blank"
                        ...
                        <p className="text-sm text-gray-400 mt-4">
                          Откроется в Google Drive • Доступен полноэкранный режим
                        </p>
                      </div>
                    </div>
                  );
